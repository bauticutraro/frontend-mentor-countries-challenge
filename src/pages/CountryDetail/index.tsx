import {
  useGetCountryByCca2,
  useGetCountriesByCca2
} from '../../hooks/useGetCountries';
...
const CountryDetail = () => {
  ...
  const { data: borderCountriesData, isLoading: isBorderCountrisDataLoading } =
    useGetCountriesByCca2(country?.borders || []);
  ...
  return (
    <div>
      ...
      {country ? (
          ...
          <div className='country-data'>
            ...
            <div className='country-data-details'>
              <ul className='country-data-details-list'>
                ...
                <CountryDetailItem
                  title='Population'
                  value={country.population.toLocaleString('de-DE')}
                />
              ...
              <ul className='country-data-details-list'>
                ...
                <li className='country-data-details-item'>
                  <span className='country-data-details-item-name'>
                    Languages:
                  </span>
            ...
            <div className='country-data-details-border-countries'>
              <p className='country-data-details-border-countries-name'>
                Border Countries:
              </p>
              ...
              {borderCountriesData?.length ? (
                <div className='country-data-details-border-countries-list'>
                  {borderCountriesData?.map(country => (
                    <Button
                      key={country.cca2}
                      size='sm'
                      onClick={() => onGoToBorderCountry(country.cca2)}
                    >
                      {country.name.common}
                    </Button>
                  ))}{' '}
                ...
                <span className='country-data-details-border-countries-empty'>
                  -
                </span>
              )}
            </div>
        ...
        <NotFoundText>
          No se han encontrado paises con el código cca2 igual a {cca2}.
        </NotFoundText>
      )}
    </div>
  );
