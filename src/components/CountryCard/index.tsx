        ...
        <div className="country-card-subcontainer">
          ...
          <ul className="country-card-details">
            <li className="country-card-details-item">
              <span className="country-card-details-item-name">Population:</span>
            ...
            <li className="country-card-details-item">
              ...
              <span className="country-card-details-item-text">{country.region || '-'}</span>
            </li>
            <li className="country-card-details-item">
              <span className="country-card-details-item-name">Capital:</span>
              <span className="country-card-details-item-text">{country.capital || '-'}</span>
            </li>
          </ul>
        </div>
      </div>
